(function(){
  function mount(container){
    container.innerHTML = `
      <div class="subcard">
        <h4 class="bucket-title">MP-QAP Module</h4>
        <div class="row-3">
          <div class="mini-field"><label>Module</label><input placeholder="e.g., EGFR / BRAF / NGS"></div>
    ...
    return {
      collect(){
        ...
        return { program: 'MPQAP', module: moduleInp.value, cycle: cycleSel.value, year: yearInp.value };
      },
      destroy(){ container.innerHTML=''; }
    };
  }
  window.EnrollModules = window.EnrollModules || {};
  window.EnrollModules.MPQAP = { mount };
})();
