(function(){
  function mount(container){
    container.innerHTML = `
      <div class="subcard">
        <h4 class="bucket-title">NCG-EQAS Module</h4>
        <div class="row-3">
          <div class="mini-field"><label>Module</label><input placeholder="e.g., IHC / H&E / TSP"></div>
    ...
    return {
      collect(){
        ...
        return { program: 'NCGEQAS', module: moduleInp.value, cycle: cycleSel.value, year: yearInp.value };
      },
      destroy(){ container.innerHTML=''; }
    };
  }
  window.EnrollModules = window.EnrollModules || {};
  window.EnrollModules.NCGEQAS = { mount };
})();
